<template>
  <q-card flat bordered class="q-mb-lg bg-white shadow-1 task-card">
    <div
      class="task-accent"
          ...
          <!-- <q-slide-transition>
            <div v-show="!isMinimized" class="q-mt-sm">
              <div class="row items-center q-mb-xs">
                ...
                />
                <label
                  class="text-weight-bold text-grey-8 uppercase text-caption tracking-wider"
                  >Detalhes</label
                >
              </div>
              <q-editor
    ...
    <q-slide-transition>
      <div
        v-if="modelValue.expand && modelValue.title && !isMinimized"
        class="q-pa-md bg-blue-grey-1 border-top"
      >
